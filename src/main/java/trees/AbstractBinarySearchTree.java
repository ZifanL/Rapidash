...
public abstract class AbstractBinarySearchTree {
    ...
    public int count(int element, String op) {
    	if (root == null) return 0;
    	switch (op) {
        case "<":
            return root.getCountLessThan(element);
        case "<=":
            return root.getCountLessThanOrEq(element);
        case ">":
            return root.getCountGreaterThan(element);
        case ">=":
            return root.getCountGreaterThanOrEq(element);
        default:
    ...
    public Node insert(int element) {
        ...
        while (searchTempNode != null && searchTempNode.value != null) {
            ...
            searchTempNode.count += 1;
            // No need to create a new node if the element is found
    ...
    public static class Node {
        ...
        public int getCountLessThan(int element) {
        	if (value >= element) {
        		if (left == null) {
        			return 0;
        		}
        		return left.getCountLessThan(element);
        	}
        	if (right == null) {
        		return count;
        	}
        	return count - right.count + right.getCountLessThan(element);
        }
        
        public int getCountLessThanOrEq(int element) {
        	if (value > element) {
        		if (left == null) {
        			return 0;
        		}
        		return left.getCountLessThanOrEq(element);
        	}
        	if (right == null) {
        		return count;
        	}
        	return count - right.count + right.getCountLessThanOrEq(element);
        }
        
        public int getCountGreaterThan(int element) {
        	if (value <= element) {
        		if (right == null) {
        			return 0;
        		}
        		return right.getCountGreaterThan(element);
        	}
        	if (left == null) {
        		return count;
        	}
        	return count - left.count + left.getCountGreaterThan(element);
        }
        
        public int getCountGreaterThanOrEq(int element) {
        	if (value < element) {
        		if (right == null) {
        			return 0;
        		}
        		return right.getCountGreaterThanOrEq(element);
        	}
        	if (left == null) {
        		return count;
        	}
        	return count - left.count + left.getCountGreaterThanOrEq(element);
        }
